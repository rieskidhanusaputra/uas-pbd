        ...
        <div class="row" style="min-height: 100vh;">
            ...
            <div class="col bg-dark-subtle">
                ...
                <div class="bg-dark-subtle mx-4 mt-2 p-3">
                    <form action="<?php echo base_url('dosen/addschedule'); ?>" method="POST">
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="text4" name="tgl_mengajar">
                                    </div>
                                    <div class="mb-3">
                                        <label for="text3" class="form-label">Kelas</label>
                                        <input type="text" class="form-control" id="text3" name="kelas">
                                    </div>
                                    <input class="btn btn-primary" type="submit" value="Add Schedule" name="create" />
                                </div>
                            </div>
                        </div>
                    </form>
