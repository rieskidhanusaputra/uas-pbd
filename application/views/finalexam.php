        ...
        <div class="row" style="min-height: 100vh;">
            ...
            <div class="col bg-dark-subtle">
                <div class="row mt-4 ms-4">
                    ...
                    <div class="col">
                        <a class="btn btn-primary border" href="<?php echo base_url('dosen/addfinalexam'); ?>"><i class="bi bi-plus-circle"></i> Add Exam</a>
                    </div>
                </div>
                <div class="bg-light mx-4 mt-2 p-3">
                    <table class="table table-hover table-bordered border-dark">
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            <?php foreach ($datafinalexam as $mhs) : ?>
                                <tr>
                                    <td scope="row"><?= $no++; ?></td>
                                    ...
                                    <td><?= $mhs['soal']; ?></td>
                                    <td><?= $mhs['rentang_waktu']; ?> Menit</td>
                                    <td>
                                        <a class="btn btn-warning border" href="<?php echo base_url('dosen/editfinalexam/') . $mhs['id']; ?>"><i class="bi bi-pencil-fill"></i></a>
                                        <a class="btn btn-danger border" href="<?php echo base_url('dosen/deletefinalexam/') . $mhs['id']; ?>" onclick="return confirm('Delete Finalexam?')"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
