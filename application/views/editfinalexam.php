        ...
        <div class="row" style="min-height: 100vh;">
            <div class="col-3 m-0 p-0 bg-body-secondary">
                ...
                <div class="nav nav-item flex-column text-center my-3">
                    ...
                    <a href="<?php echo base_url('dosen/listSchedule'); ?>" class="text-decoration-none text-dark my-2">Lecturer Schedule</a>
                    <a href="<?php echo base_url('dosen/listMidterm'); ?>" class="text-decoration-none text-dark my-2">Midterm Exam</a>
                    <a href="<?php echo base_url('dosen/listFinalexam'); ?>" class="bg-primary text-decoration-none text-light p-2">Final Exams</a>
            ...
            <div class="col bg-dark-subtle">
                <div class="row mt-4 ms-4">
                    <div class="col-6">
                        <h3>Edit Finalexam</h3>
                    </div>
                </div>
                <div class="bg-dark-subtle mx-4 mt-2 p-3">
                    <form action="<?php echo base_url('dosen/editfinalexam/')  . $datafinalexam['id'];; ?>" method="POST">
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="text2" class="form-label">Kode Matakuliah</label>
                                        <input type="text" class="form-control" id="text1" name="kode_matkul" value="<?= $datafinalexam['kode_matkul']; ?>">
                                    </div>
                                    <div class="my-3">
                                        <label for="text1" class="form-label">Nama Matakuliah</label>
                                        <input type="text" class="form-control" id="text2" name="nama_matkul" value="<?= $datafinalexam['nama_matkul']; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="text1" class="form-label">Program Studi</label>
                                        <input type="text" class="form-control" id="text1" name="program_studi" value="<?= $datafinalexam['program_studi']; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="text2" class="form-label">Soal</label>
                                        <input type="file" class="form-control" id="text4" name="soal" value="<?= $datafinalexam['soal']; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="text3" class="form-label">Rentang Waktu</label>
                                        <input type="text" class="form-control" id="text3" name="rentang_waktu" value="<?= $datafinalexam['rentang_waktu']; ?>">
                                    </div>
                                    <input class="btn btn-primary" type="submit" value="Edit Finalexam" name="create" />
                                </div>
                            </div>
                        </div>
                    </form>
