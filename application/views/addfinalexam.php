        ...
        <div class="row" style="min-height: 100vh;">
            ...
            <div class="col bg-dark-subtle">
                ...
                <div class="bg-dark-subtle mx-4 mt-2 p-3">
                    <form action="<?php echo base_url('dosen/addfinalexam'); ?>" method="POST">
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="text1" name="program_studi">
                                    </div>
                                    <div class="mb-3">
                                        <label for="text2" class="form-label">Soal</label>
                                        <input type="file" class="form-control" id="text4" name="soal">
                                    </div>
                                    <div class="mb-3">
                                        <label for="text3" class="form-label">Rentang Waktu</label>
                                        <input type="text" class="form-control" id="text3" name="rentang_waktu">
                                    </div>
                                    <input class="btn btn-primary" type="submit" value="Add Finalexam" name="create" />
                                </div>
                            </div>
                        </div>
                    </form>
