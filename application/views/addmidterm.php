        ...
        <div class="row" style="min-height: 100vh;">
            ...
            <div class="col bg-dark-subtle">
                ...
                <div class="bg-dark-subtle mx-4 mt-2 p-3">
                    <form action="<?php echo base_url('dosen/addmidterm'); ?>" method="POST">
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <input class="btn btn-primary" type="submit" value="Add Midterm" name="create" />
                                </div>
                            </div>
                        </div>
                    </form>
